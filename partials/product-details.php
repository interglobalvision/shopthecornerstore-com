...
<form class="cart margin-top-tiny <?php if (is_singular('product')) {
  ...
  <button type="submit" class="add-to-cart button-shop font-uppercase font-letter-spaced <?php echo is_singular('editorial') ? 'u-hidden' : ''; ?> js-product-button"><?php echo is_singular('product') ? $product_data['button_text'] : ''; ?></button>
</form>
