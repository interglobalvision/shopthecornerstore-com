...
<div class="price product-price margin-bottom-small font-product-price">$<span class=" gws-product-price"></span></div>
<div class="sold product-sold margin-bottom-small font-product-price">Sold</div>
...
<form class="gws-product-form cart margin-top-small" method="post" enctype='multipart/form-data'>
  ...
  <button class="button item-in-cart" disabled>Item in Basket</button>
</form>
